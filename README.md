...
* if you place `renders/visualize.py` into the directory with your renders and json file you can view the boxes generated by the get cordinates function. simply type `python3 visualize.py` in the directory. All the example box cordinate images are generated with this python file.
