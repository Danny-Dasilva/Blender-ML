...
#2017-01-06: Additional module: bmesh (but without the bmesh.ops - I cannot find the way to properly document these methods in this program
#            (they have no get_rna() method).
script_help_msg = '''
Usage:
...
def rna2predef(BASEPATH):
    ...
    if "bmesh" in INCLUDE_MODULES:
        ...
        pymodule2predef(BASEPATH, "bmesh", module, "BMesh module (bmesh)")

    if "bmesh.types" in INCLUDE_MODULES:
        import bmesh.types as module
        pymodule2predef(BASEPATH, "bmesh.types", module, "BMesh Types (bmesh.types)")

    if "bmesh.utils" in INCLUDE_MODULES:
        import bmesh.utils as module
        pymodule2predef(BASEPATH, "bmesh.utils", module, "BMesh Utilities (bmesh.utils)")

    if "bmesh.geometry" in INCLUDE_MODULES:
        import bmesh.geometry as module
        pymodule2predef(BASEPATH, "bmesh.geometry", module, "BMesh Geometric Utilities (bmesh.geometry)")
