...
focal_length = 10 #mm
percent_of_image = (1,1) #between -1 and 1
sensor_size = (10,5) #mm
...
print(cube.matrix_world.to_translation())
def calculate_camera_rot(percent_of_image, camera, sensor_size, object, percent_range=(0,1)):
    focal_length = bpy.data.cameras['Camera'].lens
    
    local_point_pos = object.matrix_world.to_translation()
...
camera_rot_delta = calculate_camera_rot(percent_of_image, camera, sensor_size, cube, percent_range=(-1,1))
...
distance = center_obj(camera, cube)
